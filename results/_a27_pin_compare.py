"""A-27 four-config pin comparison against the 2026-07 baseline.

Same walker as results/_wp14c_pin_compare.py; only the candidate path differs.
"""
import json
...
a = load("results/_a27_pins_candidate.json")

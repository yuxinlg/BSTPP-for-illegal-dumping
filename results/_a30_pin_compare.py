"""A-30 four-config pin comparison against the 2026-07 baseline.

Same walker as results/_a28_pin_compare.py; only the candidate path differs.
"""
import json
...
a = load("results/_a30_pins_candidate.json")

...
- **Next free: A-57, D-64, CI-11, OP-33.** Machine-independent gates run in CI under **D-63**; the pin battery stays manual. The completion manifest remains the sole execution authority (**D-53**). **OP-32** is open: distribution name and version are still upstream's.

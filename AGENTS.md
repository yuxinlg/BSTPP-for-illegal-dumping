...
- **Next free: A-59, D-64, CI-11, OP-33.** Machine-independent gates run in CI under **D-63**; the pin battery stays manual. Live document gates live under `tools/gates/`; frozen citations of `results/_a*.py` resolve through the alias table.

...
| D-35 | Freeze ships with enforcement; config `__post_init__` + single factory | active | `bstpp/config.py` `NumericalConfig.create` / `__post_init__` | ctor | `tests/test_numerical_config.py` | direct | — | keep | 3f |
